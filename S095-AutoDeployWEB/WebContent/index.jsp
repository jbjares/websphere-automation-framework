<%-- jsf:pagecode language="java" location="/src/br/gov/bnb/s033/orcamento/apresentacao/pagecode/Index.java" --%><%-- /jsf:pagecode --%><%-- tpl:insert page="/S095_BNJSFJavaWebTemplate_integrado.jtpl" --%><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
