...
public class MessageDrivenBeanTemplate_
{
  protected static String nl;
  public static synchronized MessageDrivenBeanTemplate_ create(String lineSeparator)
  {
    nl = lineSeparator;
    MessageDrivenBeanTemplate_ result = new MessageDrivenBeanTemplate_();
    nl = null;
    return result;
  }
