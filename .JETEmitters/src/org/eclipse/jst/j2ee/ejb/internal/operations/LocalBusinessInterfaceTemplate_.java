...
public class LocalBusinessInterfaceTemplate_
{
  protected static String nl;
  public static synchronized LocalBusinessInterfaceTemplate_ create(String lineSeparator)
  {
    nl = lineSeparator;
    LocalBusinessInterfaceTemplate_ result = new LocalBusinessInterfaceTemplate_();
    nl = null;
    return result;
  }
