...
public class SessionBeanTemplate_
{
  protected static String nl;
  public static synchronized SessionBeanTemplate_ create(String lineSeparator)
  {
    nl = lineSeparator;
    SessionBeanTemplate_ result = new SessionBeanTemplate_();
    nl = null;
    return result;
  }
